...
class MySQLConnection:
    ...
    def get_connection(self, database=None):
        try:
            print(f"Attempting to connect to MySQL at {self.host}:{self.port} as user {self.user}")
            ...
            print(f"Connection parameters: host={self.host}, port={self.port}, user={self.user}, database={database or self.database}")
            return None
